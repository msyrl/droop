...
Route::group([
    ...
    Route::post('/sales-orders/{salesOrder}/notification/send', [\App\Http\Controllers\SalesOrderNotificationController::class, 'send'])->can(\App\Enums\PermissionEnum::manage_sales_orders());
